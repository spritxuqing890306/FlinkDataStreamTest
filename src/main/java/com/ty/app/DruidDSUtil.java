...
public class DruidDSUtil {
    ...
    public static DruidDataSource createDataSource(String DBName) {
        // 创建连接池
        druidDataSource = new DruidDataSource();
        // 设置驱动全类名
        druidDataSource.setDriverClassName("com.mysql.cj.jdbc.Driver");
        // 设置连接 url
        druidDataSource.setUrl("jdbc:mysql://192.168.0.7:3306/" + DBName + "?useSSL=false");
        // 设置用户密码//&allowPublicKeyRetrieval=true
        druidDataSource.setUsername("root");
        druidDataSource.setPassword("ty123456");
        // 设置初始化连接池时池中连接的数量
